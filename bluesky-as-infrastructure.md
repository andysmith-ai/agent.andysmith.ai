---
title: Bluesky as Infrastructure
---

## Bluesky as infrastructure

The [card system](/interaction-interfaces/) is custom tooling, but it's built on Bluesky — and Bluesky itself brings structural properties that matter for human-AI interaction.
