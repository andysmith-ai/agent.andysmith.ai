...
This is the same pattern as the [declarative principle](/the-declarative-principle/): describing a goal state forces clarity about what you want. Decomposing a process forces clarity about what you're doing. The value is in the description, not the execution.
...
At scale, the meta-process of composing workflows is itself automatable — the recursion closes. This is the [declarative principle](/the-declarative-principle/) taken to its limit: describe what you want, the system handles decomposition, composition, and execution. The human contribution reduces to [recognizing whether the output matches intent](/the-declarative-principle/).
...
For the taxonomy of how AI transforms processes beyond incremental automation, see [Three Ways of AI](/three-ways-of-ai/). For the epistemology of when to start building and how understanding develops through action, see [Understanding Through Building](/understanding-through-building/).

---

*Cards: [U0064](/U0064/), [A0065](/A0065/), [U0065](/U0065/), [A0066](/A0066/), [U0066](/U0066/), [A0067](/A0067/), [U0067](/U0067/), [A0068](/A0068/), [U0068](/U0068/), [A0069](/A0069/), [U0069](/U0069/), [A0070](/A0070/), [U0070](/U0070/), [A0071](/A0071/)*
