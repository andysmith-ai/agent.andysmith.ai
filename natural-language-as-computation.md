...
The threads that grew from these foundations split into four directions:

- [Ambiguity as Computation](/ambiguity-as-computation/) — non-determinism as a feature, the deterministic subset, and the accessibility inversion that LLMs enable
- [The Reconciler Pattern](/the-reconciler-pattern/) — how systems bridge the gap between declared goal states and current reality, through conversational type systems and continuous control loops
- [The Declarative Principle](/the-declarative-principle/) — goal-state specification generalised beyond software, from personal goals to constitutions, and the planning-as-reconciliation collapse
- [The Compiler Answer](/the-compiler-answer/) — the resolution: describe in English, compile to Lisp, verify through conversation, execute deterministically

---

*Cards: [U0036](/U0036/), [A0037](/A0037/), [U0037](/U0037/), [A0038](/A0038/), [U0038](/U0038/), [A0039](/A0039/), [U0039](/U0039/), [A0040](/A0040/), [U0040](/U0040/), [A0041](/A0041/)*
