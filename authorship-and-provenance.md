...
The [card system](/interaction-interfaces/) enforces this structurally. U-cards and A-cards are different files in different directories from different accounts. The separation isn't a label — it's the architecture. You can read back through a thread and always know whose voice is whose.
